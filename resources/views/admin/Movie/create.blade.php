                        ...
                        <form role="form" action="{{route('movies-save')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" style="font-size: 15px;height: 35px" id="movie_runtime" name="movie_runtime" placeholder="Runtime">
                                </div>
                            ...
                            <div class="card-footer">
                                ...
                                <a type="button"  href="{{url('movies-details')}}" class="btn btn-warning" style="font-size: 18px">Back</a>
                            </div>
                        </form>
